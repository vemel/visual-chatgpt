...
class Canny2Image(BaseTool):
    def __init__(self, device: str) -> None:
        ...
        self.model = self.create_model("ControlNet/models/cldm_v15.yaml", device, "ControlNet/models/control_sd15_canny.pth")
        self.device = device
    ...
    def inference(self, inputs):
        ...
        updated_image_path = self.get_new_image_name(image_path, func_name="canny2image")
