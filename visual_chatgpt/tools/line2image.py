...
class Line2Image(BaseTool):
    def __init__(self, device: str) -> None:
        print("Initialize the line2image model...")
        self.model = self.create_model("ControlNet/models/cldm_v15.yaml", device, "ControlNet/models/control_sd15_mlsd.pth")
        self.device = device
    ...
    def inference(self, inputs):
        ...
        updated_image_path = self.get_new_image_name(image_path, func_name="line2image")
