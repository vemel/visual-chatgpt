...
class Depth2Image(BaseTool):
    def __init__(self, device: str) -> None:
        print("Initialize depth2image model...")
        self.model = self.create_model("ControlNet/models/cldm_v15.yaml", device, "ControlNet/models/control_sd15_depth.pth")
        self.device = device
    ...
    def inference(self, inputs: str) -> str:
        ...
        updated_image_path = self.get_new_image_name(image_path, func_name="depth2image")
